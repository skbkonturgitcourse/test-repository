Object.assign||Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:function(e){"use strict";if(null==e)throw new TypeError("Cannot convert first argument to object");for(var t=Object(e),r=1;r<arguments.length;r++){var n=arguments[r];if(null!=n){n=Object(n);for(var i=Object.keys(Object(n)),o=0,c=i.length;o<c;o++){var u=i[o],l=Object.getOwnPropertyDescriptor(n,u);void 0!==l&&l.enumerable&&(t[u]=n[u])}}}return t}}),String.prototype.includes||(String.prototype.includes=function(e,t){"use strict";return"number"!=typeof t&&(t=0),!(t+e.length>this.length)&&-1!==this.indexOf(e,t)});
...
var WebSitesSentry = {
    init: function (options) {
        var ERRORS_COUNT_KEY = 'SENTRY_ERRORS_COUNTER';
        Sentry.init({
            dsn: options.dsn,
            beforeSend: function (event) {
                try {
                    var errorsCount = sessionStorage.getItem(ERRORS_COUNT_KEY) || 0;
                    var maxErrors = options.maxErrors || 20;
                    if (errorsCount > maxErrors) {
                        return null;
                    }
                    sessionStorage.setItem(ERRORS_COUNT_KEY, +errorsCount + 1);
                    return event;                    
                } catch(e) {
                    return event;
                }
            ...
            integrations: [
                new Sentry.Integrations.RewriteFrames({
                    iteratee: function (frame) {
                        frame.filename = frame.filename.replace(/\/ver-[0-9a-zA-Z_\-]+/, '');
                        return frame;
                    }
                })
            ]
        ...
        if (options.tags) {
            for (var i = 0; i < options.tags.length; i++) {
                var option = options.tags[i];
                var tagName = option[0];
                var tagValue = option[1];
